          ...
          <div className={cn("relative flex w-full items-center")}>
            ...
            <input
              ...
              className={cn(
                ...
                "bg-transparent text-textBlack caret-textBlack placeholder:text-textBlackLight active:bg-transparent dark:caret-textBlack dark:placeholder:text-textBlackLight",
