...
function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        "custom-size fixed right-0 top-0 z-20 flex h-dvh flex-col justify-between bg-backgroundSecondary px-5 py-4 font-nunito text-base font-medium leading-[135%] dark:bg-backgroundTertiary md:p-6 md:text-xl xl:left-0 xl:h-dvh xl:rounded-r-[20px] 3xl:py-8 smOnly:overflow-y-scroll mdOnly:overflow-y-scroll mdOnly:rounded-l-[20px]",
        isOpenSidebar
          ? "w-full md:w-[256px]"
